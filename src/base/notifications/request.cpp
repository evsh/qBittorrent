...
Notifications::Request::this_type &Notifications::Request::setTitle(const QString &title)
{
    m_title = title;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setMessage(const QString &message)
{
    m_message = message;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setCategory(Category category)
{
    m_category = category;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setUrgency(Urgency urgency)
{
    m_urgency = urgency;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setSeverity(Severity severity)
{
    m_severity = severity;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setTorrent(BitTorrent::InfoHash &infoHash)
{
    m_torrentHash = infoHash;
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setTorrent(BitTorrent::TorrentHandle *torrent)
{
    m_torrentHash = torrent ? torrent->info().hash() : BitTorrent::InfoHash();
    return *this;
}

Notifications::Request::this_type &Notifications::Request::setTimeout(int timeout)
{
    m_timeout = timeout;
    return *this;
}

Notifications::Request::this_type & Notifications::Request::setUserData(const QVariant& data)
{
    m_userData = data;
    return *this;
}
...
Notifications::Request::this_type &Notifications::Request::addAction(const QString &id, const QString &label)
{
    if (!m_actions.contains(id))
        ...
        qDebug() << "Action with id " << id << " is alrady exists. Skipping";
    return *this;
}
